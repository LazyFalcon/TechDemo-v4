...
inline glm::vec4 min(const glm::vec4& a, const glm::vec4& b) {
    return glm::vec4(std::min(a.x, b.x), std::min(a.y, b.y), std::min(a.z, b.z), std::min(a.w, b.w));
}
inline glm::vec4 max(const glm::vec4& a, const glm::vec4& b) {
    return glm::vec4(std::max(a.x, b.x), std::max(a.y, b.y), std::max(a.z, b.z), std::max(a.w, b.w));
}
