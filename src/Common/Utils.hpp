...
inline glm::mat4 convert(const btTransform& trans) {
    ...
    return glm::mat4(matrix[0], matrix[1], matrix[2], matrix[3], matrix[4], matrix[5], matrix[6], matrix[7], matrix[8],
                     matrix[9], matrix[10], matrix[11], matrix[12], matrix[13], matrix[14], 1);
}
...
inline btTransform convert(const glm::mat4& mat) {
    return btTransform(
        btMatrix3x3(mat[0][0], mat[1][0], mat[2][0], mat[0][1], mat[1][1], mat[2][1], mat[0][2], mat[1][2], mat[2][2]),
        convert(mat[3]));
}
